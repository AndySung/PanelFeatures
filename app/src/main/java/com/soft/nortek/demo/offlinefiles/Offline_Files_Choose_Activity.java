package com.soft.nortek.demo.offlinefiles;
...
public class Offline_Files_Choose_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView title = findViewById(R.id.pathtext);
        ...
        titleBartitle.setText("Bluetooth send file");
        ...
        //点击监听事件
        fileView.setOnItemClickListener((adapterView, view, position, id) -> {
            ...
            if (fileClass.getImageId() == R.drawable.file)//如果点击的是文件，直接打开文件
            {
                ...
                intent1.putExtra("FileName", fileClass.getName());
                intent1.putExtra("FilePath", fileClass.getPath());
                //设置返回数据
                Offline_Files_Choose_Activity.this.setResult(RESULT_OK, intent1);
                //关闭Activity
