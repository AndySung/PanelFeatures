...
public class WifiIperfActivity extends Activity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {

    private static final String TAG = "WifiIperfActivity";
   ...
   // private static String iperfClientCmd = IPERF_PATH + " -c 172.19.0.179 -p 5001 -t 60 -P 1";
    private static String iperfClientCmd = IPERF_PATH + " -c 192.168.1.1 -p 5001 -t 60 -P 1";
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        if(buttonView.getId() == R.id.wifi_switch){
            curIperfCmd = (isChecked?iperfServiceCmd :(IPERF_PATH + " -c "+getLocalIpAddress()+" -p 5001 -t 60 -P 1"));
