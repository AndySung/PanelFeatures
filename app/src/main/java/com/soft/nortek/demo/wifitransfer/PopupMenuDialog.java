package com.soft.nortek.demo.wifitransfer;
...
public class PopupMenuDialog implements View.OnClickListener{
    private TextView mTxtTitle,mTxtSubTitle,mTxtStateHint,mTxtAddress;
    private ImageView mImgLanState;
    private Button mBtnWifiSettings,mBtnWifiCancel;
...
////    View mButtonSplitLine;
    ...
    public PopupMenuDialog builder() {
        ...
        mBtnWifiCancel = view.findViewById(R.id.shared_wifi_cancel);
        mButtonSplitLine = view.findViewById(R.id.shared_wifi_button_split_line);
        mBtnWifiCancel.setOnClickListener(this);
