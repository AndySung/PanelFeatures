...
STRINGS.UNSUPPORTED_FILE_TYPE = '目前支持文件格式有EPUB、TXT、PDF、APK、MP3、WAV、DOS、GIF、JAR、ZIP、HTML、AMR、JPG、PNG等。';
...
STRINGS.CANCEL = '取消';
STRINGS.SELECT_YOUR_FILES = '请选择您要上传到FunctionTest的文件';
STRINGS.SUPPORTED_FILE_TYPES = '支持EPUB、TXT、PDF、APK、MP3、WAV、DOS、GIF、JAR、ZIP、HTML、AMR、JPG、PNG';
